...
-- Create new policies
CREATE POLICY "drives_read_policy"
  ON drives FOR SELECT
  TO authenticated
  USING (true);

CREATE POLICY "drives_write_policy"
  ON drives FOR ALL
  TO authenticated
  USING (auth.is_admin())
...
CREATE POLICY "vent_configurations_policy"
...
CREATE POLICY "screen_configurations_policy"
...
CREATE POLICY "drive_configurations_policy"
...
CREATE POLICY "vent_freight_requirements_policy"
